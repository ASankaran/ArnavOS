...
i686-elf-ld -m elf_i386 -T link.ld -o build/kernel build/kasm.o build/kc.o build/keyasm.o build/keyboard.o build/screen.o build/terminal.o build/time.o build/programs.o build/echo.o